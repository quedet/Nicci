                ...
                <div className="file">
                    <div className="form-item form-item-file">
                        <div className="__inner">
                            ...
                            <input type="file" name='image' id="image" onChange={(evt) => { props.setImage(evt.target.files[0])}} className='form-item-file-input'/>
                            <span>Update</span>
                        </div>
                    </div>
                    <div className='form-item form-item-file-overview'>
                        <figure>
                            ...
                            {props.currentPost && (<img src={`http://localhost:1337${props.currentPost.image?.url}`} alt={""} />)}
                        </figure>
                    </div>
                </div>
                <div className="form-item form-item-description">
                    <label htmlFor="description">Description</label>
                    <textarea type="text" name='description' id="description" onChange={(evt) => { props.setDescription(evt.target.value)}} value={props.description} rows="10" />
                </div>
